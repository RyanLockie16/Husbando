...
public class AssignmentManager : MonoBehaviour
{
    ...
    private int matchQuantity = 0; //Required match number
    private int currentMatchQuantity = 0; //Matched so far
    ...
    IEnumerator FinishMatchChallenge(int current, int total) 
    {
        ...
        totalScore += (MatchScoreValue * (current/total)); //Adds total completed points
